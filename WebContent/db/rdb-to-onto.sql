CREATE DATABASE  IF NOT EXISTS `rdbtoonto` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `rdbtoonto`;
...
) ENGINE=InnoDB AUTO_INCREMENT=5233 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=45970 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=29090 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9477 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10218 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13788 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t017_disjoint_class` (
  ...
  `C011_DISJOINT_CLASS_ID` int(11) NOT NULL,
  PRIMARY KEY (`C011_CLASS_ID`,`C011_DISJOINT_CLASS_ID`),
  KEY `fk_T017_CLASS_RESTRICTION_T011_CLASS1_idx` (`C011_CLASS_ID`),
  KEY `FKo44yaa411d03t1ksd61pkmxx5` (`C011_DISJOINT_CLASS_ID`),
  CONSTRAINT `FKo44yaa411d03t1ksd61pkmxx5` FOREIGN KEY (`C011_DISJOINT_CLASS_ID`) REFERENCES `t011_class` (`C011_CLASS_ID`),
  CONSTRAINT `FKopc1vvfrjcnxses7v9koelyqr` FOREIGN KEY (`C011_CLASS_ID`) REFERENCES `t011_class` (`C011_CLASS_ID`),
...
--
-- Table structure for table `t023_column_record_value`
--

DROP TABLE IF EXISTS `t023_column_record_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t023_column_record_value` (
  `c003_column_id` int(11) NOT NULL,
  `c004_record_id` int(11) NOT NULL,
  `c023_column_value` varchar(400) DEFAULT NULL,
  PRIMARY KEY (`c003_column_id`,`c004_record_id`),
  KEY `t004_to_t023_idx` (`c004_record_id`),
  CONSTRAINT `FKbgs14xb3cj35wuc441cb4v5m9` FOREIGN KEY (`c003_column_id`) REFERENCES `t003_column` (`C003_COLUMN_ID`),
  CONSTRAINT `FKnyc9lwm5h1wv3iav7vj0uw8id` FOREIGN KEY (`c004_record_id`) REFERENCES `t004_record` (`C004_RECORD_ID`),
  CONSTRAINT `T003_to_t023` FOREIGN KEY (`c003_column_id`) REFERENCES `t003_column` (`C003_COLUMN_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `t004_to_t023` FOREIGN KEY (`c004_record_id`) REFERENCES `t004_record` (`C004_RECORD_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_type` (
  ...
  `name_database` varchar(255) DEFAULT NULL,
  `name_xml` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
